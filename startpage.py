...
importPath=r'C:\Users\Musse\Downloads\startpage\content.txt'                        # Where to find the file with the site data.
outputPath=r'C:\Users\Musse\Downloads\startpage\index.html'                         # Where to place the index.html output file. If you change this you either need to change others paths in the css too or add resources as a subfolder to that directory.
